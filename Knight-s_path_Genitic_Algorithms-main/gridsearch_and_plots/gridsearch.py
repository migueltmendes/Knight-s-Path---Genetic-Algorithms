...
for i in range(5):
    random.seed(i)
    dataset_grid_search.append(generate_matrix(minimum=-100, maximum=1000, positive_ratio= random.uniform(0.75, 0.95), seed = i))
...
def evaluate_ga(hyperparameters, dataset, evaluate_population, runs=3):
    ...
    - three_of_the_best: list with the three best parameters combination
    """
    ...
    for param_set in param_combinations:
        ...
        # Repeat the GA simulation for a given number of runs on a number of datasets
        for data in dataset:
        ...
        # Sum the medians got for the datasets
    ...
    three_of_the_best = sorted_results[:3]

    return best_params, top_score, three_of_the_best
...
best_params, best_avg_score, top3 = evaluate_ga(hyperparameters, dataset= dataset_grid_search, evaluate_population= evaluate_population)


print("Best Parameters:", best_params)
print("Best Average Score:", best_avg_score)
print("Another of the best parameters combination and its score:", top3)